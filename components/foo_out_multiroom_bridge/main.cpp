...
DECLARE_COMPONENT_VERSION(
    ...
    "a transport-neutral core, the sync scheduler, and transient encrypted AirPlay 2 ALAC streaming. "
    "PIN pairing and persisted credentials are still in progress.\n\n"
